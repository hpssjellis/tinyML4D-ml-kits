...
|<a name="13" href="#13">`13`</a> [Arducam pico4ML](https://www.uctronics.com/-rp2040-based-arducam-pico4ml-dev-board-for-machine-vision.html) | $25 |  | Has camera, IMU, microphone and LCD on the board | I could never get it working with the Arduino IDE. I havn't tried in a while | No Wifi or BLE, great price |
