...
|<a name="05" href="#05">`05`</a> my [Maker100](https://github.com/hpssjellis/maker100/blob/main/price-list-2024.md) | $500.00 |  | A complete set of Robotics, sensors, actuators, IOT and Machine Learning | Cost per student of small groups of students | This course [maker100](https://github.com/hpssjellis/maker100) looks at multiple uses for Machine Learning and uses hands on methods to show students what is possible|
